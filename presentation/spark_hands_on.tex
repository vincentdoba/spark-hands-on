...
\begin{frame}
  ...
  \frametitle{What did we saw : Transformations and Actions}
  ...
  \begin{center}
    \begin{tabular}{|c|c|c|c|}
      ...
      substract & groupByKey & & join \\
      map & sortByKey & & sortBy \\ 
       & & & value \\ \hline
      \rowcolor{lightgray} sum & collect & first & take \\ \hline
      \rowcolor{gray} exercise 5 & exercise 6 & exercise 7 & exercise 8 \\ \hline
      \textbf{where} & aggregate & sample & toDF \\
      cache & & & \\ \hline
    \end{tabular}
  \end{center}
  \normalsize
